...
namespace RadioPlayer.Model.DAO
{
    public class RadioDAO
    {
        ...
        public RadioItem getGloboFM()
        {
            RadioItem itemRadio = new RadioItem();

            itemRadio = new RadioItem("Globo", "http://sh1.upx.com.br:8098");
            itemRadio.Id = 3;
            itemRadio.Locality = "Salvador/BA";
            itemRadio.Image = new Uri("ms-appx:/Assets/GFM/100/Logo-150x50px.png");
            itemRadio.Description = "90.1 FM";
