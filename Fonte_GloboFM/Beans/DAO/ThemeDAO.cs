...
namespace RadioPlayer.Model.DAO
{
    public class ThemeDAO
    {
        ...
        public List<Theme> getThemeList()
        {
            ...
            globoFMTheme.BackgroundImg = new Uri(baseUri, @"Assets/GFM/180/Background-1920x1080px.png");
            globoFMTheme.BackgroundImgSnap = new Uri(baseUri, @"Assets/background_snap_globo.png");
