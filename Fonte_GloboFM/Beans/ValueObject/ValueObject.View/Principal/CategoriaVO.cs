...
namespace RadioPlayer.Beans.ValueObject.ValueObject.View.Principal
{
    ...
    public class CategoriaVO : BindableBaseVO
    {
        ...
        /// Atríbuto listaItem.
        /// </summary>
        private ObservableCollection<ItemProgramacaoRadioXMLVO> listaItemProgramacaoRadioXMLVO;
        ...
        /// <summary>
        /// Gets or sets - propriedade listaItemProgramacaoRadioXMLVO.
        /// </summary>
        public ObservableCollection<ItemProgramacaoRadioXMLVO> ListaItemProgramacaoRadioXMLVO
        {
            get { return this.listaItemProgramacaoRadioXMLVO; }
            set { this.SetProperty(ref this.listaItemProgramacaoRadioXMLVO, value); }
        }
    }
}
