...
namespace RadioPlayer.Common
{
    public class GrupoNoticiaTemplateSelector : DataTemplateSelector
    {
        ...
        /// <summary>
        /// Atríbuto gridProgramacaoMusical.
        /// </summary>
        private DataTemplate gridProgramacaoMusical;
        ...
        /// <summary>
        /// Gets or sets - propriedade TemplateGridProgramacaoMusical.
        /// </summary>
        public DataTemplate TemplateGridProgramacaoMusical
        {
            get { return this.gridProgramacaoMusical; }
            set { this.gridProgramacaoMusical = value; }
        }
        /// <summary>
        ...
        protected override DataTemplate SelectTemplateCore(object item, DependencyObject container)
        {
              ...
              if (((ItemVO)item).HasGridImagemIBahia == true )
            {
              ...
              if (((ItemVO)item).HasProgramacaoMusical == true)
              {
                  return this.TemplateGridProgramacaoMusical;
              }
