...
namespace RadioPlayer.Common
{
    ...
    public partial class ExtendedSplash
    {
        ...
        public void CarregaThemeBoot()
        {
            ...
            imgGridSplash.ImageSource = new BitmapImage(new Uri("ms-appx:///Assets/GFM/180/Splash-Screen-1116x540px.png", UriKind.RelativeOrAbsolute));
            this.statusMainFirst.Foreground = new SolidColorBrush(Colors.White);
