...
namespace RadioPlayer.Common.Architecture
{
    ...
    public static class Main
    {
        ...
        public static void LoadResource()
        {
            ...
            strResource = resource.GetString("4").Split('|');

            ChannelPromocaoVO channelPromocaoVO = new ChannelPromocaoVO();

            string[] strResourceChannelPromocaoAtivo = resource.GetString("4").Split('|');
            ...
            string[] strResourceChannelPromocaoBahiaSulAtivo = resource.GetString("4").Split('|');
        ...
        public static async Task LoadChannelAsync(object objChannelVO, bool refresh)
        {
            try
            {
                ...
                else if (objChannelVO.GetType().Equals(typeof(ChannelProgramacaoRadioXMLVO)))
                {
                    ...
                    channelVO.IsLoaded = false;
                    await LoadChannelProgramacaoRadioXMLVO(channelVO, refresh);
                    channelVO.IsLoaded = true;
                }
     ...
     /// <summary>
        ...
        /// <summary>
        /// Método privado para carregar o ChannelProgramacaoRadioXMLVO.
        /// </summary>
        /// <param name="channelVO">Channel Programacao Radio XML</param>
        /// <param name="refresh">Caso for atualizar os dados</param>
        /// <returns>Retorna uma tarefa do sistema</returns>
        private static async Task LoadChannelProgramacaoRadioXMLVO(ChannelProgramacaoRadioXMLVO channelVO, bool refresh)
        {
            try
            {
                if (Util.IsConnectedToNetwork)
