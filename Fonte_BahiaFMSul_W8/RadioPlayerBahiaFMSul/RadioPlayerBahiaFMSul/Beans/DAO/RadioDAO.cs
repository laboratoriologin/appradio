...
namespace RadioPlayer.Model.DAO
{
    public class RadioDAO
    {
        ...
        public RadioItem getRadioBahiaFMSul()
        {
            RadioItem itemRadio = new RadioItem();

            itemRadio = new RadioItem("Radio Bahia FM Sul", "http://sh2.upx.com.br:8102/");
            itemRadio.Id = 2;
            itemRadio.Locality = "";
            //radio.Image = new Uri("ms-appx:/Assets/bahia_sul.png");
            itemRadio.Image = new Uri("ms-appx:/Assets/BFM SUL/140/Logo-na-tela-Home-131x158px - BFMSUL2.png");
            itemRadio.Description = "102.1 FM";
