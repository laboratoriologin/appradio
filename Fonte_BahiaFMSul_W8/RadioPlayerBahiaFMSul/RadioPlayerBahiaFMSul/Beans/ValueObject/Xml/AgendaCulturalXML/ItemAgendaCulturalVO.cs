...
namespace RadioPlayer.Beans.ValueObject.ValueObject.Xml.AgendaCulturalXML
{
    ...
    public class ItemAgendaCulturalVO : BindableBaseVO
    {
        ...
        /// <summary>
        /// Atríbuto urlLinkSingle.
        /// </summary>
        private string urlLinkSingle;
        ...
        /// <summary>
        /// Gets or sets - propriedade UrlLinkSingle.
        /// </summary>
        public string UrlLinkSingle
        {
            get { return this.urlLinkSingle; }
            set { this.SetProperty(ref this.urlLinkSingle, value); }
        }
        ...
        /// <summary>
        /// Gets or sets - propriedade gratis.
        /// </summary>
        public string Gratis
        {
            get { return this.gratis; }
            set { this.SetProperty(ref this.gratis, value); }
        }
