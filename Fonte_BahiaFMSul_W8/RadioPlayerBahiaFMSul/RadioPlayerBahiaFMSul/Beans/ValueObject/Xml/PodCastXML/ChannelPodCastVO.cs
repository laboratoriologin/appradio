...
namespace RadioPlayer.Beans.ValueObject.ValueObject.Xml.PodCastXML
{
    ...
    /// </summary>
    [KnownType(typeof(ChannelPodCastVO))]
    [DataContractAttribute]
    public class ChannelPodCastVO : BindableBaseVO
    {
        #region Atríbutos
     ...
     /// <summary>
        ...
        /// Atríbuto Item
        /// </summary>
        private ObservableCollection<ItemPodCastVO> listaItem;
        ...
        /// </summary>
        public ChannelPodCastVO()
        {
            this.isLoaded = false;
            this.listaItem = new ObservableCollection<ItemPodCastVO>();
        }
        #endregion
        ...
        /// </summary>
        public ObservableCollection<ItemPodCastVO> ListaItem
        {
