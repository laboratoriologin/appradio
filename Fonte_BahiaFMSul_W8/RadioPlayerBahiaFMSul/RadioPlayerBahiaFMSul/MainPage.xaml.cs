...
namespace RadioPlayer
{
    ...
    public sealed partial class MainPage : RadioPlayer.Common.LayoutAwarePage
    {
        ...
        public MainPage()
        {
            ...
            using (Tracker tracker = new Tracker("UA-1974624-61", ""))
            {
                tracker.TrackPageViewAsync("APP Bahia FM SUL", "api/create");
            }
            #endregion
            ...
            Uri strBanner = new Uri(@"http://www.centraldedownload.com.br/radio/bahiafmsul/whatsapp.html");
            Uri strBannerSquare = new Uri(@"http://www.centraldedownload.com.br/radio/bahiafmsul/square.html");
            Uri strBannerSnapped = new Uri(@"http://www.centraldedownload.com.br/radio/bahiafmsul/snapped.html");
        ...
        {
            SolidColorBrush colorItem = HexColorToBrush("#FFFFFF");
            SolidColorBrush colorFont = HexColorToBrush("#FFFFFF");
            ...
            foreach (RadioCategory cat in listCategory)
            {
                ...
                foreach (RadioItem radio in cat.Items)
                {
                    ...
                    radio.Image = new Uri("ms-appx:/Assets/BFM_SUL/140/Logo-na-tela-Home-131x158px - BFMSUL2.png");
            ...
            loadRadioItem(radioBO.getRadioBahiaFMSul(), false);
        ...
        private void loadThemeList()
        {
            ...
            {
                this.CreateTheme(radioBO.getRadioBahiaFMSul().Id);
                isBlockGridInicial = false;
            }
            else
            {
        ...
        private void loadRadioList()
        {
            ...
            this.loadRadioItem(radioBO.getRadioBahiaFMSul(), true);

            //this.loadRadioItem(radioBO.getRadioBahiaFM(), true);

            //switch ((RadioItem)GetRadioGrid().SelectedValue.Id)
            //{
            //    case 1:
        ...
        //private void updatePlayerButtons(int intCorButtons)
        //{
        //    switch (intCorButtons)
        //    {
        //        case 0:

        //            prevBtn.IsEnabled = true;
        //            prevBtnSnapped.IsEnabled = true;

        //            nextBtn.IsEnabled = true;
        //            nextBtnSnapped.IsEnabled = true;

        //            prevImg.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgRetrocederFlag));
        //            prevImgSnapped.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgRetrocederFlag));

        //            nextImg.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgAvancarFlag));
        //            nextImgSnapped.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgAvancarFlag));

        //            if (radioIndex == 0)
        //            {
        //                prevImg.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgRetrocederDesabilitadoFlag));
        //                prevImgSnapped.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgRetrocederDesabilitadoFlag));

        //                prevBtn.IsEnabled = false;
        //                prevBtnSnapped.IsEnabled = false;
        //            }
        //            else if (radioIndex == GetRadioGrid().Items.Count - 1)
        //            {
        //                nextImg.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgAvancarDesabilitadoFlag));
        //                nextImgSnapped.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgAvancarDesabilitadoFlag));

        //                nextBtn.IsEnabled = false;
        //                nextBtnSnapped.IsEnabled = false;
        //            }
        ...
        //            prevImg.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgRetrocederAzul));
        //            prevImgSnapped.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgRetrocederAzul));

        //            nextImg.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgAvancarAzul));
        //            nextImgSnapped.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgAvancarAzul));

        //            if (radioIndex == 0)
        //            {
        //                prevImg.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgRetrocederDesabilitadoAzul));
        //                prevImgSnapped.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgRetrocederDesabilitadoAzul));
        ...
        //            else if (radioIndex == GetRadioGrid().Items.Count - 1)
        //            {
        //                nextImg.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgAvancarDesabilitadoAzul));
        //                nextImgSnapped.Source = new BitmapImage(new Uri(this.BaseUri, Constantes.imgAvancarDesabilitadoAzul));
        ...
        private void radiosGrid_Tapped(object sender, Windows.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
            ...
            this.radioIndex = 2;
            loadRadioItem(radioBO.getRadioBahiaFMSul(), true);
            ...
            categoriaVO.ListaItem = Util.CarregaGridProgramacao().Where(itemProgramacao => itemProgramacao.GuidCategory.Equals(127)).ToObservableCollection();
            ...
            //objMenu.FontColor = Constantes.strCor;
            //lstCategoria = DataSourceRadio.LstCategoriaBahiaFMSul.ToList();
            ...
            categoriaVO.ListaItem = Util.CarregaGridPromocaoBahiaSulFM();
            ...
            objMenu.Categoria = "Fala Bahia Sul";
            objMenu.FontColor = Constantes.strCor;

            categoriaVO.ListaItem = new ObservableCollection<ItemVO>();
            categoriaVO.Id = 2;
            categoriaVO.NomeCategoria = "Fala Bahia Sul";
        ...
        public void Play()
        {
            PlaySound(radioBO.getRadioBahiaFMSul().Url);
        ...
        {
            RadioItem item = radioBO.getRadioBahiaFMSul();
            MediaControl.ArtistName = item.Locality;
            MediaControl.TrackName = item.Title;
        ...
        private async void gridNoticias_ItemClick(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                if (((ItemVO)e.ClickedItem).IdChannel.Equals(89))
                {
                    ...
                    if (DataSourceRadio.ListaChannelSalvadorVO.Count > 0)
                    {
                        ...
                        if (((ItemVO)e.ClickedItem).Guid.Equals(89))
                        {
        ...
        {
            Launcher.LaunchUriAsync(new Uri(Util.ShareFacebook(@"https://www.facebook.com/bahiafmsul")));
        ...
        {
            Launcher.LaunchUriAsync(new Uri(Util.ShareTwitter(@"https://twitter.com/bahiafmsul", "Bahia FM")));
        ...
        private void btnInstagramGeral_Click(object sender, RoutedEventArgs e)
        {
            ...
            Launcher.LaunchUriAsync(new Uri("http://instagram.com/BAFM1021"));
        }
        ...
        private async void banner_LoadCompleted(object sender, NavigationEventArgs e)
        {
            try
            {
                ...
                Uri targetUri = new Uri(@"http://www.centraldedownload.com.br/Radio/BahiaFMSul/SquareBannerPage.html");
