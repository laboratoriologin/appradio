...
namespace RadioPlayer.Common.Architecture
{
    ...
    public static class Main
    {
        ...
        public static void LoadResource()
        {
            ...
            string[] strResourceChannelPromocaoAtivo = strResource;
            ...
            string[] strResourceChannelPromocaoBahiaSulAtivo = resource.GetString("2").Split('|');
        ...
        public static void LoadMain()
        {
            ...
            try
            {
                ...
                foreach (ChannelProgramacaoVO itemChannelProgramcaoVO in DataSourceRadio.ListaChannelProgramacaoVO)
                {
                    DataSourceRadio.ListaTarefaLoadDados.Add(new Task(delegate
                    {
                        LoadChannelAsync(itemChannelProgramcaoVO, true).Wait();
                    }, itemChannelProgramcaoVO));
                }
