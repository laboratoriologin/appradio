...
namespace RadioPlayer.Common
{
    public class GrupoNoticiaTemplateSelector : DataTemplateSelector
    {
        ...
        /// <summary>
        /// Atríbuto gridProgramacao.
        /// </summary>
        private DataTemplate gridProgramacao;


        /// <summary>
        /// Gets or sets - propriedade TemplateProgramacao.
        /// </summary>
        public DataTemplate TemplateProgramacao
        {
            get { return this.gridProgramacao; }
            set { this.gridProgramacao = value; }
        }
        ...
        protected override DataTemplate SelectTemplateCore(object item, DependencyObject container)
        {
              ...
              if (((ItemVO)item).HasGridImagemIBahia == true )
            {
              ...
              if (((ItemVO)item).HasProgramacao == true)
              {
                  return this.TemplateProgramacao;
              }
