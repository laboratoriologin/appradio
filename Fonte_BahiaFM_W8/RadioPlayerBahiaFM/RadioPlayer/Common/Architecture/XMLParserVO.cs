    ...
    public class XMLParserVO
    {
        ...
        public static async Task LoadXmlUrl(object channel)
        {
            try
            {
                ...
                else if (channel.GetType().Equals(typeof(ChannelCorreioVO)))
                {
                    ChannelCorreioVO channelVO = (ChannelCorreioVO)channel;
                    await LoadXmChannelCorreioUrl(channelVO);
                }
                else if (channel.GetType().Equals(typeof(ChannelSalvadorVO)))
                {
                    ChannelSalvadorVO channelVO = (ChannelSalvadorVO)channel;
                    await LoadXmChannelSalvadorUrl(channelVO);
                }
                else if (channel.GetType().Equals(typeof(ChannelProgramacaoVO)))
                {
                    ChannelProgramacaoVO channelVO = (ChannelProgramacaoVO)channel;
                    await LoadXmChannelProgramacaoUrl(channelVO);
                }
                ...
                else if (channel.GetType().Equals(typeof(ChannelPromocaoVO)))
                {
                    ...
                    LoadXmChannelPromocaoBahiaUrl(channelVO);
        ...
        /// </summary>
        /// <param name="channel"> Obj de channel do VO</param>
        private static async Task LoadXmChannelPromocaoBahiaUrl(ChannelPromocaoVO channel)
        {
            try
            {
                XmlDocument pvtXmlDocument = await XDocToXmlDoc(Constantes.strURLBahiaFM);
                ...
                foreach (IXmlNode node in itemNodeList)
                {
                    ...
                    channel.ListaItem.Add(itemVO);
                    DataSourceRadio.ListaItemPromocaoBahiaFMVO.Add(itemVO);
                }
        ...
        /// <summary>
        /// Método para carregar o xml da Fala Bahia no VO
        /// </summary>
        /// <param name="channel"> Obj de channel Fala Bahia</param>        
        ...
        /// <summary>
        /// Método para carregar o xml da Programacao da radio Bahia FM.
        /// </summary>
        /// <param name="channel"> Obj de channel Programacao do VO</param>        
