...
namespace RadioPlayer.Model.DAO
{
    public class ThemeDAO
    {
        ...
        public List<Theme> getThemeList()
        {
            ...
            bahiaFMTheme.BackgroundImg = new Uri(baseUri, @"Assets/BFM/100/Background-1920x1080px.png");
            bahiaFMTheme.BackgroundImgSnap = new Uri(baseUri, @"Assets/background_snap_bahia.png");
            bahiaFMTheme.LogoImg = new Uri(baseUri, @"Assets/BFM/100/Logo-na-tela-Home-302x163px.png");
            ...
            bahiaFMSULTheme.BackgroundImg = new Uri(baseUri, @"Assets/BFM_SUL/bg_bahiasul.png");
            bahiaFMSULTheme.BackgroundImgSnap = new Uri(baseUri, @"Assets/BFM_SUL/background_snap_bahiasul.png");
            bahiaFMSULTheme.LogoImg = new Uri(baseUri, @"Assets/BFM_SUL/logo_home_bahiasul.png");
            ...
            cbnTheme.Title = "CBN";
            cbnTheme.BackgroundImg = new Uri(baseUri, @"Assets/CBN/bg_cbnfmsalvador.png");
            cbnTheme.BackgroundImgSnap = new Uri(baseUri, @"Assets/CBN/background_snap_cbnfmsalvador.png");
            cbnTheme.LogoImg = new Uri(baseUri, @"Assets/CBN/100/Logo-na-tela-Home-302x163px.png");
