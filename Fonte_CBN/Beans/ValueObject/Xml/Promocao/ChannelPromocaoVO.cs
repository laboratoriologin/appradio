...
{
    /// <summary>
    /// Classe Value Object ChannelPromocaoVO.
    /// </summary>
    [KnownType(typeof(ChannelPromocaoVO))]
    [DataContractAttribute]
    public class ChannelPromocaoVO : BindableBaseVO
    {
          #region Atríbutos
     ...
     /// <summary>
        ...
        /// Atríbuto content
        /// </summary>
        private ImageChannelPromocaoVO image;
        ...
        /// Atríbuto Item
        /// </summary>
        private ObservableCollection<ItemPromocaoVO> listaItem;
        ...
        /// </summary>
        public ChannelPromocaoVO()
        {
            this.isLoaded = false;
            this.listaItem = new ObservableCollection<ItemPromocaoVO>();
        }
        #endregion
        ...
        /// </summary>
        public ImageChannelPromocaoVO Image
        {
        ...
        /// </summary>
        public ObservableCollection<ItemPromocaoVO> ListaItem
        {
