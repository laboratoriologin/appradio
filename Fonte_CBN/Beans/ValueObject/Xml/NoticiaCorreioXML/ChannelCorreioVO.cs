...
namespace RadioPlayer.Beans.ValueObject.ValueObject.Xml.NoticiaCorreioXML
{
    ...
    /// </summary>
    [KnownType(typeof(ChannelVO))]
    [DataContractAttribute]
    public class ChannelCorreioVO : BindableBaseVO
    {
        #region Atríbutos
        ...
        /// Atríbuto Item
        /// </summary>
        private ObservableCollection<ItemCorreioVO> listaItem;

        #endregion

        #region Construtor
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelVO"/> class.
        /// </summary>
        public ChannelCorreioVO()
        {
            this.isLoaded = false;
            this.listaItem = new ObservableCollection<ItemCorreioVO>();
        }
        #endregion
        ...
        /// </summary>
        public ObservableCollection<ItemCorreioVO> ListaItem
        {
