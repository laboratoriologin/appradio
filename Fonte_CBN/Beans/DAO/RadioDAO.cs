...
namespace RadioPlayer.Model.DAO
{
    public class RadioDAO
    {
        ...
        public RadioItem getCBNFM()
        {
            ...
            itemRadio = new RadioItem("CBN", "http://sh1.upx.com.br:8100/");
            itemRadio.Id = 4;
            itemRadio.Description = "91,3 FM";
            itemRadio.Locality = "Salvador";
            itemRadio.Image = new Uri("ms-appx:/Assets/CBN/180/Logo-270x270px.png");
