...
namespace RadioPlayer.Common.Architecture
{
    ...
    public static class Main
    {
        ...
        public static void LoadResource()
        {
            ...
            ////
            resource = new ResourceLoader("ResourcesSalvador");
            strResource = resource.GetString("0").Split('|');


            ChannelSalvadorVO channelSalvadorVO = new ChannelSalvadorVO();

            string[] strResourceChannelSalvador = resource.GetString(y.ToString()).Split('|');
            channelSalvadorVO.Id = 105;
            channelSalvadorVO.NomeChannel = "Salvador";
            channelSalvadorVO.Url = strResourceChannelSalvador[0];

            DataSourceRadio.ListaChannelSalvadorVO.Add(channelSalvadorVO);
            LoadChannelAsync(channelSalvadorVO, true);
            ////
            ////
            resource = new ResourceLoader("ResourcesProgramacaoRadio");
            strResource = resource.GetString("0").Split('|');


            ChannelProgramacaoRadioXMLVO channelProgramacaoRadioXMLVO = new ChannelProgramacaoRadioXMLVO();

            string[] strResourceChannelProgramacaoRadioXML = resource.GetString(y.ToString()).Split('|');
            channelProgramacaoRadioXMLVO.Id = 175;
            channelProgramacaoRadioXMLVO.NomeChannel = "Programação da rádio";
            channelProgramacaoRadioXMLVO.Url = strResourceChannelProgramacaoRadioXML[0];

            DataSourceRadio.ListaChannelProgramacaoRadioVO.Add(channelProgramacaoRadioXMLVO);
            LoadChannelAsync(channelProgramacaoRadioXMLVO, true);
            ////
            ...
            string[] strResourceChannelProgramacaoCBN = resource.GetString(y.ToString()).Split('|');
            channelProgramacaoVO.Id = 405;
            channelProgramacaoVO.NomeChannel = "Programação";
            channelProgramacaoVO.Url = strResourceChannelProgramacaoCBN[0];
        ...
        public static async Task LoadChannelAsync(object objChannelVO, bool refresh)
        {
            try
            {
                ...
                else if (objChannelVO.GetType().Equals(typeof(ChannelProgramacaoRadioXMLVO)))
                {
                    ChannelProgramacaoRadioXMLVO channelVO = (ChannelProgramacaoRadioXMLVO)objChannelVO;
                    channelVO.IsLoaded = false;
                    await LoadChannelChannelProgramacaoRadioXMLVOAsync(channelVO, refresh);
                    channelVO.IsLoaded = true;
                }
        ...
        public static void LoadMain()
        {
            ...
            try
            {
                ...
                foreach (ChannelProgramacaoVO itemChannelProgramacaoVO in DataSourceRadio.ListaChannelProgramacaoVO)
                {
                    DataSourceRadio.ListaTarefaLoadDados.Add(new Task(delegate
                    {
                        LoadChannelAsync(itemChannelProgramacaoVO, true).Wait();
                    }, itemChannelProgramacaoVO));
                }

                foreach (ChannelProgramacaoRadioXMLVO itemChannelProgramacaoVO in DataSourceRadio.ListaChannelProgramacaoRadioVO)
                {
                    DataSourceRadio.ListaTarefaLoadDados.Add(new Task(delegate
                    {
                        LoadChannelAsync(itemChannelProgramacaoVO, true).Wait();
     ...
     /// <summary>
        ...
        /// <summary>
        /// Método privado para carregar o channel de ChannelProgramacaoRadioXMLVO.
        /// </summary>
        /// <param name="channelVO">Channel de ChannelProgramacaoRadioXMLVO.</param>
        /// <param name="refresh">Caso for atualizar os dados</param>
        /// <returns>Retorna uma tarefa do sistema</returns>
        private static async Task LoadChannelChannelProgramacaoRadioXMLVOAsync(ChannelProgramacaoRadioXMLVO channelVO, bool refresh)
        {
            try
            {
                if (Util.IsConnectedToNetwork)
